...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'All' for activities without difficulty specified)
    """
    ...
    if difficulty:
        if difficulty == "All":
            # Special case: "All" means activities WITHOUT a difficulty field
